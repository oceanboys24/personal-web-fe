  ...
  return (
    <div className="lg:flex lg:gap-10 xl:p-10 xl:gap-20 mb-30 items-center lg:flex-row  lg:justify-between lg:items-center xl:">
      ...
      <div className="flex flex-col justify-center gap-3 ">
        ...
        <p className="text-gray-600 text-xl lg:text-2xl lg:text-start text-center font-normal">
          Web Developer & SysAdmin
        </p>
        <p className="text-center lg:text-lg lg:text-start text-gray-500 mb-5">
        ...
        <p className="flex gap-2 text-gray-500 justify-center lg:justify-start">
          <CiLocationOn />
          Mojokerto, Sambiroto ,Indonesia
        </p>

        <p className="flex gap-2 text-gray-500 justify-center mb-5 lg:justify-start">
